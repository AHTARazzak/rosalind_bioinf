...
Goal: The substrings of s∗ encoding the edges of the suffix tree for s. You may list these substrings in any order.
'''
import sys
...
with open(sys.argv[1]) as input_data, open('submit.txt', 'w') as output_data:
